<template>
  <div class="isolated-server">
    <div class="details container">
      <h2 class="subtitle has-text-white has-text-weight-bold">Local Network Explorer</h2>
...
export default {
  ...
  methods: {
    async handleBuildContainer() {
      this.installLogs = ["Installing Local Network Explorer. This may take a while..."];
      this.loading = true;
